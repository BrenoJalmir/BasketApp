...
Projeto: settings.gradle.kts:25
Application ID: build.gradle.kts:15
...
Requisitos
Android Studio atualizado (recomendado)
SDK Android instalado para API 36
JDK 21 disponível no ambiente (compatível com o toolchain configurado)
